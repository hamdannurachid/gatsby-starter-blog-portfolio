...
export default function PrevWorks() {
    return (
      ...
      {
        allMarkdownRemark (
            filter: {frontmatter: {key: {eq: "works"}, category: {eq: "archived"}}}, 
                ...
                <Section>
                    <div className="flex justify-center gap-8" >
                        <div className="w-full mt-12 lg:mt-0 lg:col-span-2">
                            ...
                            <div className="mx-auto mt-4 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-8 lg:mx-0 lg:max-w-none lg:grid-cols-3">
                                    ...
                                    <Link to={`/works/` + node.fields.slug}>
                                        <article className="flex flex-col items-start hover:shadow-lg border-2 border-gray-200 overflow-hidden rounded-lg h-full">
                                            ...
                                            <div className="w-full p-4">
                                                <h5 className="mb-3 group-hover:text-gray-600">
